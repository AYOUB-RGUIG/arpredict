  ...
  return <div className="min-h-screen">
      ...
      <section className="relative min-h-screen gradient-hero overflow-hidden flex items-center">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center pt-20 pb-16">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-7xl font-extrabold text-primary-foreground mb-6 animate-fade-in-up animate-delay-100"><span className="text-accent">AI</span>
          </h1>
